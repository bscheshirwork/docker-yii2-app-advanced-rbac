...
```
for i in api backend common console frontend; do for j in main-local.php params-local.php; do mkdir -p /home/dev/projects/yii2advanced_config/php-code/$i/config; cp -p /home/dev/projects/yii2advanced/php-code/$i/config/$j /home/dev/projects/yii2advanced_config/php-code/$i/config/$j; done; done;
```
