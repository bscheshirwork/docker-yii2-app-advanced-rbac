...
```sh
for i in api backend common console frontend; do for j in "main-local.php" "params-local.php"; do scp /home/dev/projects/docker-yii2-app-advanced-rbac/php-code/$i/config/$j dev@host:/home/dev/projects/docker-yii2-app-advanced-rbac/php-code/$i/config/$j; done; done
```

Восстановление (настроек "как на сервере"), соответственно, обратное
```sh
for i in api backend common console frontend; do for j in main-local.php params-local.php test-local.php; do sudo cp -p /home/dev/projects/docker-yii2-app-advanced-rbac_config/php-code/$i/config/$j /home/dev/projects/docker-yii2-app-advanced-rbac/php-code/$i/config/$j; done; done;
```
